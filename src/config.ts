...
export const MONGODB_URL =
  process.env.MONGODB_URL || "mongodb://127.0.0.1:27017/growtrade";
...
export const RPC_WEBSOCKET_ENDPOINT =
  process.env.RPC_WEBSOCKET_ENDPOINT || "ws://api.mainnet-beta.solana.com";
export const PRIVATE_RPC_ENDPOINT =
...
export const private_connection = new Connection(
  PRIVATE_RPC_ENDPOINT,
  COMMITMENT_LEVEL
);

export const RESERVE_WALLET = new PublicKey(
  "B474hx9ktA2pq48ctLm9QXJpfitg59AWwMEQRn7YhyB7"
);
...
export const GROWSOL_API_ENDPOINT =
  process.env.GROWSOL_API_ENDPOINT || "http://127.0.0.1:5001";
export const PNL_IMG_GENERATOR_API =
  process.env.PNL_IMG_GENERATOR_API || "http://127.0.0.1:3001";
